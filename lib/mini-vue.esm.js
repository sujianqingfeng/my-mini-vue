...
function createSetter() {
    return function set(targe, key, value, receiver) {
...
const readonlyHandles = {
    ...
    set: function (target, key, value) {
        console.warn(`readonly not call set ,target:${target},key:${String(key)},value:${value}`);
...
export { compileToFunction, computed, createApp, createVNode as createElementVNode, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, nextTick, provide, proxyRefs, reactive, readonly, ref, registerRuntimeCompile, renderSlots, shallowReadonly, toDisplayString, toReactive, unRef };
